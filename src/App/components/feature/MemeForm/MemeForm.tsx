      ...
      <form>
        ...
        <div className={style.half}>
          <div>
            ...
            <br />
            <input type="number" className={style.smallInput} value={0} />
          </div>
          <div>
        ...
        <br />
        <input type="color" id="f_color" value="#000000" />
        <div className={style.half}>
          <div>
        ...
        <div className={style.half}>
          <div>
            ...
            <br />
            <input id="f_underline" type="checkbox" checked={false} />
          </div>
          <div>
            <label htmlFor="f_italic">italic:</label>
            <br />
            <input id="f_italic" type="checkbox" checked={false} />
          </div>
        </div>
        <hr />
        <div className={style.half}>
